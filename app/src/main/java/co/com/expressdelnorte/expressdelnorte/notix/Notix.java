...
public class Notix {
    ...
    private void initSocket() {
        ...
        try {
            mSocket = IO.socket("http://ec2-54-175-121-21.compute-1.amazonaws.com:4000");
    ...
    private void entrega(final JSONObject forConfirming) {
        ...
        String url = "http://ec2-54-175-121-21.compute-1.amazonaws.com:4000/upload";
        try {
    ...
    private void cancelar(final JSONObject forCancelling) {
        UploadNotificationConfig notificationConfig = new UploadNotificationConfig()
                ...
                .setCompletedMessage("Subida completada exitosamente en [[ELAPSED_TIME]]")
                .setAutoClearOnSuccess(true);
        String url = "http://ec2-54-175-121-21.compute-1.amazonaws.com:4000/cancel";
        try {
            new MultipartUploadRequest(context, url)
                    .setNotificationConfig(notificationConfig)
                    .setAutoDeleteFilesAfterSuccessfulUpload(true)
